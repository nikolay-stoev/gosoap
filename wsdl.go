...
func getWsdlBody(u string, myClient *http.Client) (reader io.ReadCloser, err error) {
...
func getWsdlDefinitions(u string, myClient *http.Client) (wsdl *wsdlDefinitions, err error) {
	reader, err := getWsdlBody(u, myClient)
	if err != nil {
		return nil, err
	}
	defer reader.Close()
